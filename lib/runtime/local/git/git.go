...
const defaultRepo = "github.com/lack-io/services"
...
func (s *Source) RuntimeName() string {
	if s.Repo == "github.com/lack-io/services" || s.Repo == "" {
		return s.Folder
	}
...
func ParseSource(source string) (*Source, error) {
	// If github is not present, we got a shorthand for `lack-io/services`
	if !strings.Contains(source, "github.com") {
		source = "github.com/lack-io/services/" + source
	}
