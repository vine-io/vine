...
import (
	...
	"github.com/lack-io/vine/gogenerator/generator"
	"github.com/lack-io/vine/gogenerator/namer"
	"github.com/lack-io/vine/gogenerator/parser"
...
func New() *Generator {
	...
	defaultProtoImport := filepath.Join(sourceTree, "github.com", "lack-io", "vine", "vendor", "github.com", "gogo", "protobuf", "gogoproto")
	cwd, err := os.Getwd()
	if err != nil {
...
func (g *Generator) BindFlags(flag *flag.FlagSet) {
	...
	flag.StringVar(&g.MetadataPackages, "metadata-packages", g.MetadataPackages, "comma-separated list of directories to get metadata input types from which are needed by any API. Directories prefixed with '-' are not generated, directories prefixed with '+' only create types with explicit IDL instructions.")
	...
	flag.StringSliceVar(&g.ProtoImport, "proto-import", g.ProtoImport, "The search path for the core protobuf .protos, required; defaults $GOPATH/src/github.com/lack-io/vine/vendor/github.com/gogo/protobuf/gogoproto.")
