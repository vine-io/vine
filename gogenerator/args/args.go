...
func Default() *GeneratorArgs {
	return &GeneratorArgs{
		...
		GoHeaderFilePath:           filepath.Join(DefaultSourceTree(), "github.com/lack-io/vine/gogenerator/boilerplate/boilerplate.go.txt"),
...
func (g *GeneratorArgs) AddFlags(fs *pflag.FlagSet) {
	fs.StringSliceVarP(&g.InputDirs, "input-dirs", "i", g.InputDirs, "Comma-separated list of import paths to get input type from.")
	...
	fs.StringVarP(&g.GoHeaderFilePath, "go-header-file", "h", g.GoHeaderFilePath, "File containing boilerplate header text. The string YEAR will be replace with the current 4-digit year.")
