...
// source: github.com/lack-io/vine/proto/registry/server/server.proto
...
func (*EmptyResponse) Descriptor() ([]byte, []int) {
	return fileDescriptor_3f7c92a805ba2220, []int{0}
}
...
func (*GetRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_3f7c92a805ba2220, []int{1}
}
...
func (*GetResponse) Descriptor() ([]byte, []int) {
	return fileDescriptor_3f7c92a805ba2220, []int{2}
}
...
func (*ListRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_3f7c92a805ba2220, []int{3}
}
...
func (*ListResponse) Descriptor() ([]byte, []int) {
	return fileDescriptor_3f7c92a805ba2220, []int{4}
}
...
func (*WatchRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_3f7c92a805ba2220, []int{5}
}
...
func init() {
	proto.RegisterFile("github.com/lack-io/vine/proto/registry/server/server.proto", fileDescriptor_3f7c92a805ba2220)
}
...
func (c *registryClient) GetService(ctx context.Context, in *GetRequest, opts ...grpc.CallOption) (*GetResponse, error) {
	out := new(GetResponse)
	err := c.cc.Invoke(ctx, "/server.Registry/GetService", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *registryClient) Register(ctx context.Context, in *registry.Service, opts ...grpc.CallOption) (*EmptyResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/server.Registry/Register", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *registryClient) Deregister(ctx context.Context, in *registry.Service, opts ...grpc.CallOption) (*EmptyResponse, error) {
	out := new(EmptyResponse)
	err := c.cc.Invoke(ctx, "/server.Registry/Deregister", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *registryClient) ListServices(ctx context.Context, in *ListRequest, opts ...grpc.CallOption) (*ListResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/server.Registry/ListServices", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *registryClient) Watch(ctx context.Context, in *WatchRequest, opts ...grpc.CallOption) (Registry_WatchClient, error) {
	stream, err := c.cc.NewStream(ctx, &_Registry_serviceDesc.Streams[0], "/server.Registry/Watch", opts...)
	if err != nil {
		return nil, err
	}
...
var _Registry_serviceDesc = grpc.ServiceDesc{
	...
	Metadata: "github.com/lack-io/vine/proto/registry/server/server.proto",
}
