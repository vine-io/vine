...
import (
	...
	"github.com/lack-io/vine/auth/provider"
	...
	configSrc "github.com/lack-io/vine/config/source"
	"github.com/lack-io/vine/debug/profile"
	"github.com/lack-io/vine/debug/profile/http"
	"github.com/lack-io/vine/debug/profile/pprof"
	...
	// registry
	registrySrv "github.com/lack-io/vine/registry/service"

	// clients
	cgrpc "github.com/lack-io/vine/client/grpc"
	cmucp "github.com/lack-io/vine/client/mucp"

	// servers
	sgrpc "github.com/lack-io/vine/server/grpc"
	...
	// registries
	"github.com/lack-io/vine/registry/mdns"
	rmem "github.com/lack-io/vine/registry/memory"
	regSrv "github.com/lack-io/vine/registry/service"

	// runtimes
	lRuntime "github.com/lack-io/vine/runtime/local"
	srvRuntime "github.com/lack-io/vine/runtime/service"

	// selectors
	"github.com/lack-io/vine/client/selector/dns"
	"github.com/lack-io/vine/client/selector/static"

	// transports
	thttp "github.com/lack-io/vine/transport/http"
	tmem "github.com/lack-io/vine/transport/memory"

	// stores
	memStore "github.com/lack-io/vine/store/memory"
	svcStore "github.com/lack-io/vine/store/service"

	// config
	configSrv "github.com/lack-io/vine/config/source/service"

	// tracers
	memTracer "github.com/lack-io/vine/debug/trace/memory"

	// auth
	jwtAuth "github.com/lack-io/vine/auth/jwt"
	svcAuth "github.com/lack-io/vine/auth/service"

	// auth providers
	"github.com/lack-io/vine/auth/provider/basic"
	"github.com/lack-io/vine/auth/provider/oauth"
)
