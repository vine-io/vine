...
type ObjectMeta struct {
	...
	// Read-Only
	// +optional
	CreationTimestamp int64 `json:"creationTimestamp,omitempty" protobuf:"varint,4,opt,name=creationTimestamp"`
	...
	// Read-Only
	// +optional
	UpdateTimestamp int64 `json:"updateTimestamp,omitempty" protobuf:"varint,5,opt,name=updateTimestamp"`
	...
	// Read-Only
	// +optional
	DeletionGrace bool `json:"deletionGrace,omitempty" protobuf:"varint,6,opt,name=deletionGrace"`
	...
	// Read-Only
	// +optional
	DeletionTimestamp int64 `json:"deletionTimestamp,omitempty" protobuf:"varint,7,opt,name=deletionTimestamp"`
	...
	OwnerReferences []OwnerReference `json:"ownerReferences,omitempty" protobuf:"bytes,10,rep,name=ownerReferences"`
}
