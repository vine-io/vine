...
import (
	...
	"github.com/lack-io/vine/internal/sync"
...
// storage is an implementation of certmagic.Storage using vine's sync.Map and store.Store interfaces.
...
// NewStorage returns a certmagic.Storage backed by a vine/lock and vine/store
