...
import (
	...
	"github.com/lack-io/vine/internal/codec/jsonrpc"
	"github.com/lack-io/vine/internal/codec/protorpc"
	"github.com/lack-io/vine/internal/ctx"
	"github.com/lack-io/vine/internal/qson"
	"github.com/lack-io/vine/internal/router"
...
func (h *rpcHandler) ServeHTTP(w http.ResponseWriter, r *http.Request) {
	...
	if h.s != nil {
		...
		if err != nil {
			writeError(w, r, errors.InternalServerError("go.vine.api", err.Error()))
			return
		}
		service = s
	} else {
		// we have no way of routing the request
		writeError(w, r, errors.InternalServerError("go.vine.api", "no route found"))
		return
	}
