...
// and parses it out into both possibilities. This code takes no responsibility for knowing representation was intended
// but with a knowledge of all GroupKinds, calling code can take a very good guess. If there only two segments, then
...
// to avoid automatic coercion. It doesn't use a GroupVersion a avoid custom marshalling
...
// GroupVersionKind unambiguously identifies a kind. It doesn't anonymously include GroupVerion
// to avoid automatic coercion. It doesn't use a GroupVersion to a void custom marshalling
...
// String puts "group" and "version" into single "group/version" string. Fr the legacy v1
// it returns "v1".
...
// if none of the options match the group. It prefers a match to group and version just group.
...
func ParseGroupVersion(gv string) (GroupVersion, error) {
	// this can be the internal version for the legacy vine types
	if (len(gv) == 0) || (gv == "/") {
...
// WithResource creates GroupVersionResource based on the method receiver's GroupVersion and the passed Resource.
func (gv GroupVersion) WithResource(resource string) GroupVersionResource {
	return GroupVersionResource{Group: gv.Group, Version: gv.Version, Resource: resource}
}

// GroupVersions can be used to represent a set of desired group versions.
type GroupVerions []GroupVersion

// Identifier implements runtime.GroupVersioner interface.
func (gvs GroupVerions) Identifier() string {
...
func (gvs GroupVerions) KindForGroupVersionKinds(kinds []GroupVersionKind) (GroupVersionKind, bool) {
...
// ToAPIVersionKind is a convenience method for satisfying runtime.Object on types that
// do not use TypeMeta.
...
// do not use TypeMeta, This method exists to support test and legacy serializations
