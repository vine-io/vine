...
// Package kubernetes implements kubernetes vine runtime
package kubernetes
...
func (k *kubernetes) create(resource runtime.Resource, opts ...runtime.CreateOption) error {
	...
	case runtime.TypeService:
		...
		if options.Resources == nil && options.Namespace != "vine" {
...
func (k *kubernetes) Read(opts ...runtime.ReadOption) ([]*runtime.Service, error) {
	...
	if len(options.Type) > 0 {
		labels["vine"] = client.Format(options.Type)
	}
...
func NewRuntime(opts ...runtime.Option) runtime.Runtime {
	// get default options
	options := runtime.Options{
		// Create labels with type "vine": "service"
		Type: "service",
	}
