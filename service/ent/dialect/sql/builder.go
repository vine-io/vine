...
type Builder struct {
	...
	total        int           // toal number of parameters in query tree
	errs         []error       // errors that added during the query construction
}

// Quota quotes the given identifier with the characters based
...
// IdenComma calls Ident on all arguments and adds a comma between them.
...
// postgres reports if the builder dialect is PostgresSQL.
