...
import (
	...
	"github.com/lack-io/vine/internal/selector"
	"github.com/lack-io/vine/internal/selector/roundrobin"
	"github.com/lack-io/vine/service/client"
	grpcc "github.com/lack-io/vine/service/client/grpc"
...
func (p *Proxy) filterRoutes(ctx context.Context, routes []router.Route) []router.Route {
	...
	for _, route := range routes {
		...
		if net, ok := md.Get("Vine-Namespace"); ok && len(net) > 0 {
...
func (p *Proxy) ServeRequest(ctx context.Context, req server.Request, rsp server.Response) error {
	...
	// if there is a proxy being used, e.g. vine network, we don't need to
