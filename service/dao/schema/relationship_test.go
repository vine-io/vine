...
func TestBelongsToOverrideForeignKey(t *testing.T) {
	...
	type User struct {
		...
		Profile      Profile `dao:"ForeignKey:ProfileRefer"`
		ProfileRefer int
	}
...
func TestBelongsToOverrideReferences(t *testing.T) {
	...
	type User struct {
		...
		Profile   Profile `dao:"ForeignKey:ProfileID;References:Refer"`
		ProfileID int
	}
...
func TestBelongsToWithOnlyReferences(t *testing.T) {
	...
	type User struct {
		...
		Profile      Profile `dao:"References:Refer"`
		ProfileRefer int
	}
...
func TestSelfReferentialBelongsToOverrideReferences(t *testing.T) {
	type User struct {
		ID        int32 `dao:"primaryKey"`
		Name      string
		CreatedBy *int32
		Creator   *User `dao:"foreignKey:CreatedBy;references:ID"`
	}
...
func TestHasOneOverrideForeignKey(t *testing.T) {
	...
	type User struct {
		...
		Profile Profile `dao:"ForeignKey:UserRefer"`
	}
...
func TestHasOneOverrideReferences(t *testing.T) {
	...
	type User struct {
		...
		Refer   string
		Profile Profile `dao:"ForeignKey:UserID;References:Refer"`
	}
...
func TestMany2ManyOverrideForeignKeyAndReferences(t *testing.T) {
	...
	type User struct {
		...
		Profiles  []Profile `dao:"many2many:user_profiles;ForeignKey:Refer;JoinForeignKey:UserReferID;References:UserRefer;JoinReferences:ProfileRefer"`
		Profiles2 []Profile `dao:"many2many:user_profiles2;ForeignKey:refer;JoinForeignKey:user_refer_id;References:user_refer;JoinReferences:profile_refer"`
		Refer     uint
	}
...
func TestMany2ManyOverrideForeignKey(t *testing.T) {
	...
	type User struct {
		...
		Profiles []Profile `dao:"many2many:user_profiles;ForeignKey:Refer;References:UserRefer"`
		Refer    uint
	}
...
func TestMany2ManyOverrideJoinForeignKey(t *testing.T) {
	...
	type User struct {
		...
		Profiles []Profile `dao:"many2many:user_profile;JoinForeignKey:UserReferID;JoinReferences:ProfileRefer"`
		Refer    uint
	}
...
func TestMany2ManyWithMultiPrimaryKeys(t *testing.T) {
	type Tag struct {
		ID     uint   `dao:"primary_key"`
		Locale string `dao:"primary_key"`
		Value  string
	}
	...
	type Blog struct {
		...
		Subject    string
		Body       string
		Tags       []Tag `dao:"many2many:blog_tags;"`
		SharedTags []Tag `dao:"many2many:shared_blog_tags;ForeignKey:id;References:id"`
		LocaleTags []Tag `dao:"many2many:locale_blog_tags;ForeignKey:id,locale;References:id"`
	}
...
func TestMultipleMany2Many(t *testing.T) {
	...
	type Person struct {
		ID       int
		Likes    []Thing `dao:"many2many:likes"`
		Dislikes []Thing `dao:"many2many:dislikes"`
	}
...
func TestSameForeignKey(t *testing.T) {
	...
	type User struct {
		...
		Name string
		UUID string
		Aux  *UserAux `dao:"foreignkey:UUID;references:UUID"`
	}
