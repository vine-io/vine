...
import (
	...
	"github.com/lack-io/vine/codec/jsonrpc"
	"github.com/lack-io/vine/codec/protorpc"
...
func (h *rpcHandler) ServeHTTP(w http.ResponseWriter, r *http.Request) {
	...
	if h.s != nil {
		...
		if err != nil {
			writeError(w, r, errors.InternalServerError(api.DefaultName, err.Error()))
			return
		}
		service = s
	} else {
		// we have no way of routing the request
		writeError(w, r, errors.InternalServerError(api.DefaultName, "no route found"))
		return
	}
