...
import (
	...
	goapi "github.com/lack-io/vine/api"
...
func (a *apiHandler) ServeHTTP(w http.ResponseWriter, r *http.Request) {
	...
	if err != nil {
		er := errors.InternalServerError(goapi.DefaultName, err.Error())
	...
	if a.s != nil {
		...
		er := errors.InternalServerError(goapi.DefaultName, "no route found")
		w.Header().Set("Content-Type", "application/json")
		w.WriteHeader(500)
		w.Write([]byte(er.Error()))
		return
