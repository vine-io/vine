...
import (
	...
	clinamespace "github.com/lack-io/vine/client/cli/namespace"
	...
	pb "github.com/lack-io/vine/proto/signup"
...
func init() {
	cmd.Register(&cli.Command{
		Name:        "signup",
		Usage:       "Signup to the Vine Platform",
		Description: "Enables signup to the Vine Platform which can then be accessed via `vine env set platform` and `vine login`",
		Action:      Run,
		Flags: []cli.Flag{
			&cli.StringFlag{
				Name:  "email",
			...
			&cli.BoolFlag{
				Name:  "recover",
				Usage: "Emails you the namespaces you have access to. vine signup --recover --email=youremail@domain.com",
			},
		},
	})
}
