...
func (g *dao) generateSchemaCURDMethods(file *generator.FileDescriptor, schema *Schema) {
	...
	g.P(fmt.Sprintf(`func (m *%s) FindPage(ctx context.Context, page, size int, exprs ...clause.Expression) ([]*%s, int64, error) {`, source, g.wrapPkg(target)))
